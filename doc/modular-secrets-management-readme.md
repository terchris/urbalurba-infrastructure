...
**File**: `doc/modular-secrets-management-readme.md`
...
- **🏗️ Git Workflow**: `doc/rules-git-workflow.md`
- **🚦 Ingress Configuration**: `doc/rules-ingress-traefik.md`
- **🤖 AI Environment**: `doc/package-ai-environment-management.md`
