...
This document establishes mandatory rules for creating and maintaining documentation in the `doc/` folder. These rules ensure consistency, discoverability, and maintainability across all documentation types in the Urbalurba infrastructure.
...
**File**: `doc/package-[category]-[service].md`
