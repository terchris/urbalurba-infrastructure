...
**File**: `doc/rules-development-workflow.md`
...
There are many rules to follow read doc/rules-readme.md for an overview. 
Or just all doc/rules-*.md 
...
✅ **Correct:** `doc/rules-development-workflow.md`
...
1. **File Operations** (Read/Write/Edit)
   ...
   - Read: doc/rules-development-workflow.md
   ```
...
```bash
# On Mac
vim doc/rules-development-workflow.md
...
7. ✅ Always review relevant doc/rules-*.md files before changes

**When in doubt:**
- Check this document
- Review other doc/rules-*.md files
